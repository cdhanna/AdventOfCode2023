...
public class Tests
{
    private const string SampleInputPart1 = @"1abc2
pqr3stu8vwx
a1b2c3d4e5f
treb7uchet";

    private const string SampleInputPart2 = @"two1nine
eightwothree
abcone2threexyz
xtwone3four
4nineeightseven2
...
7pqrstsixteen";
    ...
    private const string Part1Input = @"2xjzgsjzfhzhm1
...
9lgmxktj1frxl";
    ...
    [TestCase(SampleInputPart1, 142)]
    [TestCase(Part1Input, 54081)]
    public void Part1(string input, int expected)
    {
        ...
        foreach (var line in lines)
        {
            ...
            var part = (first.ToString() + last.ToString());
            sum += int.Parse(part);
        }
        Assert.AreEqual(expected, sum);
    }
    
    [TestCase(SampleInputPart2, 281)]
    [TestCase(Part1Input, 54649)]
    public void Part2(string input, int expected)
    {
        ...
        foreach (var line in lines)
        {
            ...
            for (var i = 0; i < line.Length; i++)
            {
                ...
                {
                    if (line.Substring(i).StartsWith(x.Key))
                    {
                        c = x.Value;
                        // i += x.Key.Length - 1;
                        break;
